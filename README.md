...
| `base-tag`       | No       | Use a specific tag release instead of the latest available one taken by default. For example, if the base release is specified as `v1.0.0` and the latest release is `v2.0.0`, the release changelog will include all changes made in releases between `v1.0.0` and the new release                                                                                                                                                                                                                                         |
## Motivation
